        ...
        mProfileSendFrndsReq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCurrent_state.equals(REQ_RECEIVED)) {
                    ...
                    final DatabaseReference notifyRef = FirebaseDatabase.getInstance().getReference().child("Notifications").child(mCurrent_user.getUid());
                    Query query = notifyRef.orderByChild("from").equalTo(user_id);
                    query.addChildEventListener(new ChildEventListener() {
                        @Override
                        public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                            if (dataSnapshot.child("type").getValue().toString().equals("friend_request")) {
