...
public class MessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void configureMyChatViewHolder(final MyChatViewHolder myChatViewHolder, int position) {
        ...
        String alphabet = messages.getMessage().substring(0, 1);

        myChatViewHolder.messageText.setText(messages.getMessage());
        myChatViewHolder.timeText.setText(alphabet);
    ...
    private void configureOtherChatViewHolder(final OtherChatViewHolder otherChatViewHolder, int position) {
        ...
        otherChatViewHolder.messageText.setText(messages.getMessage());
        otherChatViewHolder.timeText.setText(alphabet);
